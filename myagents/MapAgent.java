...
import exploration.FriendsKnowledge;
...
public abstract class MapAgent extends AbstractDedaleAgent {
	...
	private int tries = 0;
	private ArrayList<String> uselessTiles = new ArrayList<String>();
	
	private ArrayList<String> hunters;
	private String huntingPos = null;
	
	private int blockCount = 0;
	private int blockLoopCount = 0;
	private String blockLoopPos;
	...
	public void addToUseless(String tile) {
		this.uselessTiles.add(tile);
	}
	
	public List<String> getUselessTiles() {
		return  Collections.unmodifiableList(this.uselessTiles) ;
	}
...
//		}
	...
	public int getBlockLoopCount() {
		return blockLoopCount;
	}

	
	public void increaseBlockLoopCount() {
		blockLoopCount++;
	}

	public void resetBlockLoopCount() {
		blockLoopCount = 0;
	}


	public String getBlockLoopPos() {
		return blockLoopPos;
	}


	public void setBlockLoopPos(String blockLoopPos) {
		this.blockLoopPos = blockLoopPos;
	}
